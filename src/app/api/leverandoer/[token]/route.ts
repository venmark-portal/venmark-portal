...
export async function POST(req: NextRequest, { params }: { params: { token: string } }) {
  ...
  const data: Record<string, any> = {
    ...
    qualityManagerEmail: form.get('qualityManagerEmail') as string || null,
    qualityManagerPhone: form.get('qualityManagerPhone') as string || null,
    ...
    certData:          form.get('certData')        as string || null,
    ...
    signatureData:     form.get('signatureData')   as string || null,
